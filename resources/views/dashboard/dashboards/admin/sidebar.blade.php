    ...
    <div class="scroll-sidebar">
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <hr>
                <h5 style="margin-left: 2em"><strong> Manage Pembejeo</strong></h5>
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ route('pembejeo.create') }}"
                        aria-expanded="false">
                        <i class="fas fa-people-carry" aria-hidden="true"></i>
                        <span class="hide-menu">Add Pembejeo</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ route('pembejeo.index') }}"
                        aria-expanded="false">
                        <i class="fa fa-info-circle" aria-hidden="true"></i>
                        <span class="hide-menu">View Pembejeo</span>
                    </a>
                </li>
                <hr>
                ...
                <li class="sidebar-item">
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="sidebar-link waves-effect waves-dark sidebar-link btn btn-link" aria-expanded="false">
